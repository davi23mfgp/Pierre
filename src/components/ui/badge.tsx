  ...
  "inline-flex items-center rounded-full px-2.5 py-0.5 text-[12px] font-medium transition-colors focus:outline-none",
  {
    variants: {
      variant: {
        ...
        success:     "bg-ios-blue/10 text-emerald-600 dark:text-ios-green/80 border border-emerald-500/15",
        warning:     "bg-ios-orange/10 text-amber-600 dark:text-ios-orange border border-amber-500/20",
