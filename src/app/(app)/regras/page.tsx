...
export default function Regras() {
  ...
  return (
    <div className="space-y-4">
      <Cartao
        titulo="O que o Pierre aprendeu"
        acao={
      ...
      >
        ...
        <p className="mt-3 text-[12px] leading-relaxed text-muted-fg">
          Toda vez que você corrige a categoria de um lançamento, o Pierre cria uma regra aqui. Quanto mais regras, menos
