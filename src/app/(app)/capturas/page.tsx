    ...
    <div className="space-y-4">
      <Cartao titulo="Anotar em segundos">
        ...
        <p className="mt-2 text-[12px] text-muted-fg">
          Escreva como você falaria: <b>uber 18</b>, <b>farmácia 38,90</b>, <b>almoço 45</b>. O Pierre adivinha a
          categoria pelo nome.
        </p>
      </Cartao>
      ...
      <Cartao titulo="Ligar o celular ao Pierre">
        ...
        <div className="mt-4 grid gap-3 lg:grid-cols-2">
          ...
          <div className="rounded-2xl border border-hairline p-4">
            ...
            <ol className="mt-2 space-y-1.5 text-[12px] leading-relaxed text-muted-fg">
              ...
              <li>
                2. No Telegram, abra o bot do Pierre e mande
