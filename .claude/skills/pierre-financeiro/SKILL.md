---
name: pierre-financeiro
description: Regras de cálculo financeiro do app Pierre — centavos inteiros, taxas em pontos-base, saldo derivado, cheque especial como saldo negativo. Use ao mexer em qualquer código que envolva dinheiro, juros, projeção, saldo, parcela, dívida, meta ou indicador financeiro neste projeto.
---

# Cálculo financeiro no Pierre
...
`src/lib/pierre/panorama.ts` é a **fonte única**. Precisa de um número novo numa
