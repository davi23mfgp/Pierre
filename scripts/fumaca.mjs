...
const EMAIL = process.env.EMAIL_FUMACA ?? "demo@pierre.local"
...
async function entrar() {
  ...
  const cookie = resposta.headers.getSetCookie().find((linha) => linha.startsWith("pierre_sessao="))
  if (!cookie) throw new Error("login respondeu 200 mas não mandou o cookie pierre_sessao.")
